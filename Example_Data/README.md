The SNPs input file provided will run with the *dadi_Run_Optimizations.py* script, as long as the file path is changed in the script to reflect its location on your computer. 
